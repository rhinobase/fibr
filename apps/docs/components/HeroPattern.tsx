  ...
  return (
    <div className="absolute inset-0 -z-10 mx-0 max-w-none overflow-hidden">
      <div className="absolute left-1/2 top-0 ml-[-38rem] h-[25rem] w-[81.25rem] dark:[mask-image:linear-gradient(white,transparent)]">
        <div className="from-primary-300 dark:from-primary-600/30 absolute inset-0 bg-gradient-to-r to-indigo-300 opacity-40 [mask-image:radial-gradient(farthest-side_at_top,white,transparent)] dark:to-indigo-600/30 dark:opacity-100">
          <GridPattern
            width={72}
            height={56}
            x={-12}
